...
class FantasyCardFactory(CardFactory):
    ...
    def create_creature(self, name_or_power: str | int | None = None) -> Card:
        if isinstance(name_or_power, str):
            ...
            return CreatureCard("Creature", 3, "Legendary", name_or_power, name_or_power + 3)
        else:
    ...
    def create_artifact(self, name_or_power: str | int | None = None) -> Card:
        if isinstance(name_or_power, str):
            return ArtifactCard(name_or_power, 2, "Legendary", 3, "+1 mana per turn")
        elif isinstance(name_or_power, int):
            return ArtifactCard("Artifact", 2, "Legendary", name_or_power, "+1 mana per turn")
        else:
