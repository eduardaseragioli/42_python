"""Demo script for exercise 2 multiple-interface elite card."""
...
def main() -> None:
    """Run elite card combat and magic demo."""
    print("=== DataDeck Ability System ===\n")

    print("EliteCard capabilities:")

    method_card: list[str] = ['play', 'get_card_info', 'is_playable']
    method_com: list[str] = ['attack', 'defend', 'get_combat_stats']
    method_magic: list[str] = [
    ...
    target: dict[str, Any] = {"name": "Enemy", "health": 10}
