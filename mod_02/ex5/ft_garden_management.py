...
class GardenManager:
    """Manage garden operation includ add plants watering and health check"""

    def __init__(self):
        """Initialize the garden manager with empty plant e full water tank"""
        self.plants = {}
        self.water_tank = 100

    def water_plants(self) -> None:
        """Waters all plants in the garden and ensures cleanup"""
        try:
    ...
    def check_plant_health(self, plant_name,
        ...
        """Validates plant health based on water and sunlight levels"""
        if not plant_name:
            raise PlantError("Plant name cannot be empty!")
        if water_level < 1:
...
def test_garden_management():
    """Tests the garden management system with various scenarios"""
